...
namespace HospitalMS {
    ...
    public partial class HMSDataSet5 : global::System.Data.DataSet {
        ...
        public partial class WardDataTable : global::System.Data.TypedTableBase<WardRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public WardRow AddWardRow(string WardName) {
...
namespace HospitalMS.HMSDataSet5TableAdapters {
    ...
    public partial class WardTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Ward] WHERE (([Id] = @Original_Id) AND ((@IsNull_WardName = 1 " +
                "AND [WardName] IS NULL) OR ([WardName] = @Original_WardName)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Ward] ([WardName]) VALUES (@WardName);\r\nSELECT Id, WardName FR" +
                "OM Ward WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Ward] SET [WardName] = @WardName WHERE (([Id] = @Original_Id) AND (" +
                "(@IsNull_WardName = 1 AND [WardName] IS NULL) OR ([WardName] = @Original_WardNam" +
                "e)));\r\nSELECT Id, WardName FROM Ward WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, WardName FROM dbo.Ward";
        ...
        public virtual int Fill(HMSDataSet5.WardDataTable dataTable) {
        ...
        public virtual HMSDataSet5.WardDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            HMSDataSet5.WardDataTable dataTable = new HMSDataSet5.WardDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(HMSDataSet5.WardDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_WardName) {
        ...
        public virtual int Insert(string WardName) {
            if ((WardName == null)) {
        ...
        public virtual int Update(string WardName, int Original_Id, string Original_WardName, int Id) {
            if ((WardName == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string WardName, int Original_Id, string Original_WardName) {
            return this.Update(WardName, Original_Id, Original_WardName, Original_Id);
        }
    }
